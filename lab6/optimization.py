...
def gradient_descent(oracle, x_0, tolerance=1e-5, max_iter=10000,
    ...
    while True:
        ...
        if np.dot(grad_k, grad_k) <= tolerance * np.dot(grad_0, grad_0):
...
def newton(oracle, x_0, tolerance=1e-5, max_iter=100,
    ...
    while True:
        ...
        # except LinAlgError:
        # если не получилось разложение Холецкого, то LU
        #    lu, piv = scipy.linalg.lu_factor(oracle.hess(x_k))
        #    d_k = scipy.linalg.lu_solve((lu, piv), -grad_k)
