...
class BaseSmoothOracle(object):  # здесь ничего не надо менять
    """
...
class QuadraticOracle(BaseSmoothOracle):  # квадратичный оракул делает квадратичную функцию, чтобы проверить, что градиентный спуск работает, его менять не надо
    """
